    ...
    <div className="space-y-6">
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-white text-2xl mt-2">{kpi.value}</p>
                    <p className="text-green-500 text-2xl mt-2">{kpi.change}</p>
                  </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-slate-900/50 border-slate-800 backdrop-blur">
          <CardHeader>
            <CardTitle className="text-white text-3xl">Upcoming Games</CardTitle>
          </CardHeader>
            ...
            {upcomingGames.map((game) => (
              <div key={game.id} className="flex items-center justify-between p-4 bg-slate-800/50 rounded-lg">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {game.status === 'live' && (
                    <Badge className="bg-red-600 text-xl hover:bg-red-700">
                      Live
                    </Badge>
                  )}
                </div>
        ...
        <Card className="bg-slate-900/50 border-slate-800 backdrop-blur">
          <CardHeader>
            <CardTitle className="text-white text-3xl">Recent Results</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              <div key={result.id} className="p-4 bg-slate-800/50 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3 flex-1">
                    <span className="text-white text-2xl">{result.team1}</span>
                    <span className="text-purple-400 text-2xl">{result.score1}</span>
                  </div>
                  <Badge variant="outline" className="text-slate-300 text-xl border-slate-600">
                    {result.sport}
                  </Badge>
                ...
                <div className="flex items-center gap-3">
                  <span className="text-white text-2xl">{result.team2}</span>
                  <span className="text-slate-400 text-2xl">{result.score2}</span>
                </div>
              </div>
            ))}
          </CardContent>
      ...
      <Card className="bg-slate-900/50 border-slate-800 backdrop-blur">
        <CardHeader>
          <CardTitle className="text-white text-3xl">Season Progress</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div>
            <div className="flex justify-between mb-2 text-2xl">
              <span className="text-slate-300 text-2xl">Basketball League</span>
              <span className="text-slate-400 text-2xl">78% Complete</span>
            </div>
            <Progress value={78} className="h-2" />
          </div>
          <div>
            <div className="flex justify-between mb-2">
              <span className="text-slate-300 text-2xl">Volleyball League</span>
              <span className="text-slate-400 text-2xl">65% Complete</span>
            </div>
            <Progress value={65} className="h-2" />
          </div>
          <div>
            <div className="flex justify-between mb-2">
              <span className="text-slate-300 text-2xl">Football League</span>
              <span className="text-slate-400 text-2xl">52% Complete</span>
            </div>
