          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors cursor-pointer ${
              isActive
                ...
                : 'text-slate-300 hover:bg-slate-800 hover:text-white text-2xl'
            }`}
          >
      ...
      <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 w-64 bg-slate-900 border-r border-slate-800 flex-col">
        ...
        <div className="p-4 border-t border-slate-800">
          <Button
            onClick={onLogout}
            variant="ghost"
            className="w-full justify-start text-slate-300 hover:text-white hover:bg-slate-800 text-2xl cursor-pointer"
          >
